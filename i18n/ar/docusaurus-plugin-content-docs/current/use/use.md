...
ScriptCat هو إضافة متصفح يمكنها تنفيذ سكربتات المستخدم، متوافقة مع سكربتات Tampermonkey، وتوفر ميزات إضافية. إذا وجدت أي أخطاء أو كانت لديك اقتراحات، يمكنك زيارة [مستودع GitHub](https://github.com/scriptscat/scriptcat) لتقديم ملاحظاتك.
...
⑤ انقر على أيقونة ScriptCat في الزاوية العلوية اليمنى، ثم انقر على `┆` > الحصول على السكربتات في الزاوية العلوية اليمنى من الواجهة التي تظهر، ويمكنك الانتقال إلى موقع السكربتات للبحث عن السكربتات وتثبيتها.
...
## الحصول على السكربتات

> بالإضافة إلى السكربتات، يمكنك أيضاً الحصول على بعض معلومات السكربتات والدروس من [منتدى Tampermonkey الصيني](https://bbs.tampermonkey.net.cn/) و[دليل تطوير السكربتات](https://learn.scriptcat.org/).

### موقع ScriptCat للسكربتات

[موقع ScriptCat للسكربتات](https://scriptcat.org/) هو موقع السكربتات الخاص بهذه الإضافة، حيث يمكنك نشر السكربتات التي تكتبها.

- موقع سكربتات جديد
- سكربتات الخلفية/السكربتات المجدولة
- واجهة سهلة الاستخدام

### بحث Userscript.Zone

[بحث Userscript.Zone](https://www.userscript.zone/?utm_source=tm.net&utm_medium=scripts) موقع جديد يتيح البحث عن سكربتات المستخدم عن طريق إدخال عناوين URL أو نطاقات مناسبة.
...
يمكنك [البحث عن موارد السكربتات في Github و Gist.](https://gist.github.com/search?l=JavaScript&o=desc&q="%3D%3DUserScript%3D%3D"&s=updated)
...
- [تثبيت السكربتات](/docs/use/script_installation/): التثبيت من متاجر السكربتات، بما في ذلك دعم [سكربتات الخلفية](/docs/dev/background/).
- الإدارة والتشغيل: التحرير، التشغيل/الإيقاف، [UserConfig](/docs/dev/config/).
- [النسخ الاحتياطي](/docs/use/sync/) و[الانتقال من مديري السكربتات الآخرين](/docs/use/from-other/migrate-from-tampermonkey/).
- [مزامنة السكربتات](/docs/use/sync/).
