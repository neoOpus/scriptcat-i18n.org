...
إدارة السكربتات في ScriptCat عبر [sctl](https://github.com/scriptscat/sctl).
...
|---|---|
| سرد السكربتات وقراءة البيانات الوصفية | يُرجع مباشرة |
| قراءة أو البحث في كود السكربت | يتبع سياسة **قراءة المصدر** |
| تثبيت أو تحرير أو تفعيل أو تعطيل أو حذف سكربت | يتبع سياسة **الكتابة** |
...
لهذه الجلسة". تكون السماحات الخاصة بالجلسة مرتبطة بالسكربت ونوع العملية، وتُمحى عند إعادة تشغيل
...
وأسرار أخرى، بينما يمكن للكتابة تغيير السكربتات مباشرة، لذا فعّلها فقط إذا كنت تقبل هذا الخطر.
...
| `3` | أخطاء أخرى مثل الوسائط أو الاتصال أو سكربت مفقود |
...
في سكربت يطبع لافتة إلى المخرجات القياسية.

الأدوات الحالية:

| الأداة | الغرض | سياسة التأكيد |
|---|---|---|
| `scripts_list` | سرد ملخصات السكربتات | لا شيء |
| `scripts_metadata_get` | قراءة بيانات وصفية لسكربت واحد | لا شيء |
...
| `scripts_install_request` | طلب تثبيت سكربت | سياسة الكتابة |
