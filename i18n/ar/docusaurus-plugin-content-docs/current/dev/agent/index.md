...
يقدم ScriptCat v1.4 نظام المساعد الذكي Agent، والذي يوفر لسكربتات المستخدم مجموعة من القدرات مثل حوارات الذكاء الاصطناعي، وأتمتة المتصفح، وإدارة الملفات، والمهام المجدولة.
...
| [MCP](agent-mcp) | `@grant CAT.agent.mcp` | إدارة اتصالات خادم MCP |
| [تطوير Skill](agent-skill-dev) | — | دليل تطوير SKILL.cat.md + SkillScript |

## البداية السريعة

سكربت Agent بسيط للغاية:
...
```
سكربت المستخدم ← Sandbox (تنفيذ معزول)
              ↓ WindowMessage
           ...
           Service Worker (المجدول المركزي)
              ...
              ├── SkillScriptExecutor (تنفيذ سكربتات الـ Skill)
...
الـ Skill هي حزمة توسعة تحتوي على مطالبات + سكربتات أدوات + مواد مرجعية، يمكنها تزويد الـ Agent بمعرفة متخصصة وأدوات مخصصة.
...
- **التثبيت عبر سكربت** — التثبيت برمجياً عبر واجهة البرمجة `CAT.agent.skills.install()`.
