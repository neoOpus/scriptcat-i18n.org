...
تتيح واجهة برمجة المهام المجدولة للسكربت إنشاء مهام مجدولة تعتمد على تعبيرات Cron، مع وضعي تنفيذ.
...
يُدار بواسطة السكربت نفسه:
- يتم إرسال إشعار حدث إلى السكربت عندما يحدث مشغل Cron
- يستمع السكربت للحدث عبر `addListener`
...
يرجع جميع المهام التي أنشأها السكربت الحالي.
