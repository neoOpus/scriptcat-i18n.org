...
توفر واجهة برمجة الاستعلام عن النماذج وصولاً للقراءة فقط إلى النماذج التي قام المستخدم بتكوينها على صفحة الإدارة. لأسباب أمنية، لا يتم كشف مفتاح API للسكربت أبداً.
