...
- [Install scripts](/docs/use/script_installation/): install from script marketplaces, including support for [background scripts](/docs/dev/background/).
- Manage & operate: edit, run/stop, [UserConfig](/docs/dev/config/).
- [Backup](/docs/use/sync/) and [migrate from other managers](/docs/use/from-other/migrate-from-tampermonkey/).
- [Script sync](/docs/use/sync/).
- [Subscriptions](/docs/dev/subscribe/).
