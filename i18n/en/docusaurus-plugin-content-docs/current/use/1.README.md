...
ScriptCat is a powerful browser extension for executing userscripts. It offers full compatibility with Tampermonkey scripts while providing a rich set of additional features and developer tools. If you find any bugs or have suggestions, you can visit [GitHub Repo](https://github.com/scriptscat/scriptcat) to provide feedback.
