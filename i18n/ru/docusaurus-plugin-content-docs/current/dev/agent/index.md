...
|------|---------|------|
| [Диалог](./conversation) | `@grant CAT.agent.conversation` | Создание AI-диалогов, отправка сообщений, потоковые ответы, пользовательские инструменты |
| [Операции DOM](./dom) | `@grant CAT.agent.dom` | Навигация по страницам, скриншоты, клики, заполнение, прокрутка, мониторинг DOM |
| [Skill](./skill) | `@grant CAT.agent.skills` | Установка/удаление/вызов пакетов Skill |
| [Задачи по расписанию](./task) | `@grant CAT.agent.task` | Задачи по расписанию, прослушивание событий |
| [Модель](./model) | `@grant CAT.agent.model` | Запрос информации о настроенных моделях (только чтение) |
| [Файлы OPFS](./opfs) | `@grant CAT.agent.opfs` | Чтение/запись файлов рабочего пространства Agent |
| [MCP](./mcp) | — | Настройка подключений MCP-серверов (только страница управления, без API для скриптов) |
| [Разработка Skill](./skill-dev) | — | Руководство по разработке SKILL.cat.md + SkillScript |
...
Подробности: [API управления Skill](./skill) и [Руководство по разработке Skill](./skill-dev).
