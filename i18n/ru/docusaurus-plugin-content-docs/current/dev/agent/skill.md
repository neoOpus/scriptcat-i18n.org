...
О разработке и упаковке Skill см. [Руководство по разработке Skill](../skill-dev). Официальный репозиторий примеров Skill: [scriptscat/skills](https://github.com/scriptscat/skills).
...
> Примечание: `version` и `installUrl` (используются функцией проверки обновлений на странице управления) не возвращаются через этот скриптовый API — они используются только внутренней логикой проверки обновлений и UI страницы управления.
