...
Se você usa o Tampermonkey e quer migrar para o ScriptCat, aqui estão alguns passos e dicas para concluir a migração sem problemas.
...
Clique em `Utilitários` e depois em `Exportar` na seção de arquivos zip para exportar o arquivo zip
